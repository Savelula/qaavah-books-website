...
(function (global) {
  ...
  var PF = {
    en: {
      ...
      screens_tag: 'Also in the app',
      screens_h2_a: 'Three extras ',
      screens_h2_b: 'that close the gaps',
      screens_lede: 'Past the daily record — import without a bank login, prepaid cards that expire, and pots you can actually fill.',
      gal_t1: 'Statement import',
      gal_d1: 'Drop in a CSV, OFX or PDF. Match or add rows — no bank password, ever.',
      gal_t2: 'Gift cards',
      gal_d2: 'Spend from the balance and get warned before it expires unused.',
      gal_t3: 'Pots',
      gal_d3: 'Named goals with a fill bar — emergency fund, deposit, a trip.',
      gal_t4: 'Budget',
      ...
      foot_about: 'Know where it went — without linking a bank. Personal money worldwide. Shop tools in Africa & Latin America.',
      foot_op: 'Qaavah Books · Not affiliated with any bank.',
      foot_col_product: 'Product',
      foot_col_company: 'Company',
      foot_col_legal: 'Legal',
      foot_business: 'For shops & teams',
      foot_contact: 'Contact',
      foot_store: 'Listing frames',
    ...
    fr: {
      ...
      screens_tag: 'Aussi dans l’app',
      screens_h2_a: 'Trois extras ',
      screens_h2_b: 'qui ferment les trous',
      screens_lede: 'Au-delà du quotidien — importer sans login bancaire, cartes prépayées qui expirent, et pots que vous pouvez vraiment remplir.',
      gal_t1: 'Import de relevé',
      gal_d1: 'Déposez un CSV, OFX ou PDF. Associez ou ajoutez — jamais de mot de passe bancaire.',
      gal_t2: 'Cartes cadeaux',
      gal_d2: 'Dépensez le solde et soyez prévenu avant expiration.',
      gal_t3: 'Pots',
      gal_d3: 'Objectifs nommés avec une barre de remplissage — fonds d’urgence, dépôt, voyage.',
      gal_t4: 'Budget',
      ...
      foot_about: 'Sachez où est passé votre argent — sans lier de banque. Argent perso partout dans le monde. Outils boutique en Afrique et en Amérique latine.',
      foot_op: 'Qaavah Books · Non affilié à aucune banque.',
    ...
    es: {
      ...
      screens_tag: 'También en la app',
      screens_h2_a: 'Tres extras ',
      screens_h2_b: 'que cierran huecos',
      screens_lede: 'Más allá del día a día — importar sin login bancario, tarjetas prepago que caducan y huchas que sí puedes llenar.',
      gal_t1: 'Importar extracto',
      gal_d1: 'Suelta un CSV, OFX o PDF. Empareja o añade — nunca una contraseña bancaria.',
      gal_t2: 'Tarjetas regalo',
      gal_d2: 'Gasta el saldo y recibe aviso antes de que caduque.',
      gal_t3: 'Huchas',
      gal_d3: 'Metas con nombre y barra de avance — emergencia, depósito, un viaje.',
      gal_t4: 'Presupuesto',
      ...
      foot_about: 'Sepa a dónde fue — sin vincular un banco. Dinero personal en todo el mundo. Herramientas de tienda en África y Latinoamérica.',
      foot_op: 'Qaavah Books · No afiliado a ningún banco.',
      foot_col_product: 'Producto',
      foot_col_company: 'Empresa',
      foot_col_legal: 'Legal',
      foot_business: 'Para tiendas y equipos',
      foot_contact: 'Contacto',
      foot_store: 'Marcos del listing',
    ...
    pt: {
      ...
      screens_tag: 'Também na app',
      screens_h2_a: 'Três extras ',
      screens_h2_b: 'que fecham falhas',
      screens_lede: 'Além do dia a dia — importar sem login bancário, cartões pré-pagos que expiram e potes que pode mesmo encher.',
      gal_t1: 'Importar extrato',
      gal_d1: 'Largue um CSV, OFX ou PDF. Associe ou adicione — nunca uma palavra-passe bancária.',
      gal_t2: 'Cartões oferta',
      gal_d2: 'Gaste o saldo e seja avisado antes de expirar.',
      gal_t3: 'Potes',
      gal_d3: 'Metas com nome e barra de progresso — emergência, caução, uma viagem.',
      gal_t4: 'Orçamento',
      ...
      foot_about: 'Saiba para onde foi — sem ligar um banco. Dinheiro pessoal em todo o mundo. Ferramentas de loja em África e na América Latina.',
      foot_op: 'Qaavah Books · Sem afiliação a qualquer banco.',
      foot_col_product: 'Produto',
      foot_col_company: 'Empresa',
      foot_col_legal: 'Legal',
      foot_business: 'Para lojas e equipas',
      foot_contact: 'Contacto',
      foot_store: 'Molduras do listing',
